...
- Generated WM configs (autostart, kitty, polybar, rofi) live in `configs/wm-configs/`; tool configs live in `configs/tool-configs/`, including `vimrc`, `vifmrc`, and `tool-configs/colors/atta-wm.vifm` for vifm themes.
